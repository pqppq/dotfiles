...
if s:configuration.style ==# 'night'
  let s:palette = {
        ...
        \ 'grey':       ['#000000',   '246',  'Black'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
elseif s:configuration.style ==# 'storm'
  let s:palette = {
        \ 'black':      ['#06080a',   '237',  'Black'],
...
if s:configuration.transparent_background
  ...
  call s:HL('ToolbarLine', s:palette.fg, s:palette.bg0)
endif
call s:HL('ColorColumn', s:palette.none, s:palette.bg0)
...
call s:HL('CursorColumn', s:palette.none, s:palette.bg0)
...
call s:HL('MatchParen', s:palette.none, s:palette.bg0)
call s:HL('NonText', s:palette.bg0, s:palette.none)
call s:HL('Whitespace', s:palette.bg0, s:palette.none)
call s:HL('SpecialKey', s:palette.bg0, s:palette.none)
call s:HL('Pmenu', s:palette.fg, s:palette.bg0)
call s:HL('PmenuSbar', s:palette.none, s:palette.bg0)
...
call s:HL('StatusLine', s:palette.fg, s:palette.bg0)
call s:HL('StatusLineTerm', s:palette.fg, s:palette.bg0)
call s:HL('StatusLineNC', s:palette.grey, s:palette.bg0)
call s:HL('StatusLineTermNC', s:palette.grey, s:palette.bg0)
call s:HL('TabLine', s:palette.fg, s:palette.bg0)
...
call s:HL('Visual', s:palette.none, s:palette.bg0)
call s:HL('VisualNOS', s:palette.none, s:palette.bg0, 'underline')
...
elseif s:configuration.current_word ==# 'grey background'
  call s:HL('CocHighlightText', s:palette.none, s:palette.bg0)
endif
...
call s:HL('CocErrorFloat', s:palette.red, s:palette.bg0)
call s:HL('CocWarningFloat', s:palette.yellow, s:palette.bg0)
call s:HL('CocInfoFloat', s:palette.blue, s:palette.bg0)
call s:HL('CocHintFloat', s:palette.green, s:palette.bg0)
if s:configuration.transparent_background
  call s:HL('CocHintSign', s:palette.purple, s:palette.none)
else
  call s:HL('CocHintSign', s:palette.purple, s:palette.bg0)
endif
...
call s:HL('deniteInput', s:palette.green, s:palette.bg0, 'bold')
call s:HL('deniteStatusLineNumber', s:palette.purple, s:palette.bg0)
call s:HL('deniteStatusLinePath', s:palette.fg, s:palette.bg0)
...
call s:HL('CtrlPMode1', s:palette.blue, s:palette.bg0, 'bold')
call s:HL('CtrlPMode2', s:palette.bg0, s:palette.blue, 'bold')
call s:HL('CtrlPStats', s:palette.grey, s:palette.bg0, 'bold')
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call s:HL('IndentGuidesOdd', s:palette.bg0, s:palette.bg0)
  call s:HL('IndentGuidesEven', s:palette.bg0, s:palette.bg0)
endif
" }}}
...
if s:configuration.transparent_background
  ...
  call s:HL('SignatureMarkText', s:palette.blue, s:palette.bg0)
  call s:HL('SignatureMarkerText', s:palette.red, s:palette.bg0)
endif
" }}}
" mhinz/vim-startify{{{
